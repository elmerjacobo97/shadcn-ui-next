    ...
    <>
      ...
      <div className="flex overflow-hidden bg-white dark:bg-slate-900 pt-16">
        <aside
          ...
          aria-label="Sidebar"
        >
          <div className="relative flex-1 flex flex-col min-h-0 border border-gray-200 dark:border-slate-900 bg-white dark:bg-slate-900 pt-0">
                ...
                <ul className="space-y-2 pb-2">
                  {links.map((link) => (
                    <li key={link.href}>
                      <Link
                        href={link.href}
                        className="text-base capitalize text-gray-900 dark:text-slate-300 font-normal rounded-lg flex items-center p-2 hover:bg-gray-100 dark:hover:bg-slate-800 group"
                      >
        ...
        <div id="main-content" className="h-full w-full bg-gray-50 dark:bg-black relative overflow-y-auto lg:ml-64">
          <main>
            <div className="pt-6 px-4">
              <div className="w-full min-h-[calc(100vh-230px)]">
                <div className="bg-white dark:bg-slate-900 shadow rounded-lg p-4 sm:p-6 xl:p-8">{children}</div>
              </div>
            </div>
          </main>
